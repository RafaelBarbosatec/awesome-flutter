...
- [Zero to One Animation](https://medium.com/dartlang/zero-to-one-with-flutter-part-two-5aa2f06655cb) [904 claps👏] - Focus on animation by [Mikkel Ravn](https://medium.com/@mravn).
...
- [Firebase](https://www.youtube.com/watch?v=p4yLzYwy_4g) [426👍] - Firebase live coding.
- [Securing Apps](https://medium.com/@mehmetf_71205/securing-flutter-apps-ada13e806a69) [351 claps👏] - By Mehmet Fidanboylu.
...
- [Animations in Flutter](https://proandroiddev.com/animations-in-flutter-6e02ee91a0b2) [645 claps👏] - Commonly used animation examples by [Muhammed Salih Güler](https://proandroiddev.com/@muhammedsalihguler).
...
- [Rendering Engine Tutorial](https://medium.com/saugo360/flutters-rendering-engine-a-tutorial-part-1-e9eff68b825d) [411 claps👏] - Flutter's Rendering Engine: A Tutorial by [AbdulRahman AlHamali](https://github.com/AbdulRahmanAlHamali/).
...
- [Tensor Programming](https://www.youtube.com/watch?v=WwhyaqNtNQY&list=PLJbE2Yu2zumDqr_-hqpAN0nIr6m14TAsd) [70🎬] - Very rich content by [Tensor Programming](http://tensor-programming.com/).
...
- [Mtechviral](https://www.youtube.com/watch?v=qWL1lGchpRA&list=PLR2qQy0Zxs_UdqAcaipPR3CG1Ly57UlhV) [115🎬] - [Hindi/English] Mtechviral Series By [Pawan Kumar](https://github.com/iampawan).
...
- [Hidden Drawer Menu](https://github.com/RafaelBarbosatec/hidden_drawer_menu) [12⭐] - beautiful drawer mode menu feature with perspective animation by [Rafael Barbosa](https://github.com/RafaelBarbosatec).
...
- [Login](https://github.com/AppleEducate/flutter_login) [196⭐] - FaceID, TouchID, and Fingerprint Reader by [Rody Davis](http://appleeducate.com).
...
- [Test on Travis](https://medium.com/@yegorj/test-flutter-apps-on-travis-3fd5142ecd8c) [362 claps👏] - Widget testing framework by [Yegor Jbanov](https://twitter.com/yegorjbanov).
...
- [WebRTC](https://github.com/cloudwebrtc/flutter-webrtc) [250⭐] - WebRTC plugin for iOS/Android by [CloudWebRtc](https://github.com/cloudwebrtc).
- [Chewie](https://github.com/brianegan/chewie) [188⭐] - Provides low-level access to video playback by [Brian Egan](https://github.com/brianegan).

#### Voice

- [Speech Recognition](https://github.com/rxlabz/speech_recognition) [78⭐] - Speech to text by [Erick Ghaumez](https://twitter.com/rxlabz).
...
- [Inapp Purchase](https://github.com/dooboolab/flutter_inapp_purchase) [117⭐] - Features set of 'in app purchase' derived from [react-native-iap](https://github.com/dooboolab/react-native-iap) by [dooboolab](https://github.com/dooboolab).
...
- [Place Dialog](https://github.com/pinkfish/flutter_places_dialog) [27⭐] - Places picker dialog returning the places to the app by [David Bennett](https://github.com/pinkfish).
- [App Rating](https://github.com/AppleEducate/app_review) [44⭐] - Requesting and Writing Reviews for the App Store and Google Play by [Rody Davis](http://appleeducate.com).
...
- [Cache Manager](https://github.com/renefloor/flutter_cache_manager) [85⭐] - Generic cache manager by [Rene Floor](https://github.com/renefloor).
...
- [Redux Starter/Code Generator](https://github.com/hillelcoren/flutter-redux-starter) [121⭐] - Starter project and code generator with Redux support by [Hillel Coren](https://twitter.com/hillelcoren).
...
- [The One](https://www.youtube.com/watch?v=sIIgtClYq0s) [186👍]
